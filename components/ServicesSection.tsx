...
const ServicesSection = () => {
    return (
        <section className="w-full bg-white md:min-h-screen flex items-center justify-center overflow-hidden relative py-24 md:py-0">
            <div className="relative w-full flex items-center justify-center h-[300px]">
                ...
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-40 w-[412px] h-[254px]">
